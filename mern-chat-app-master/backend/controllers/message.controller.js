...
//         if (!conversation) {
//             // If conversation does not exist, return empty array with unreadMessageCount as 0
//             return res.status(200).json({ messages: [], unreadMessageCount: 0 });
//         }
...
//         // Return messages along with unread message count in the response
//         res.status(200).json({ messages, unreadMessageCount });
//     } catch (error) {
